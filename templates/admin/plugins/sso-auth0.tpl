<form class="sso-auth0-settings">
	...
	<div class="row">
		<div class="col-sm-2 col-xs-12 settings-header">User Roles</div>
		<div class="col-sm-10 col-xs-12">
			<p class="lead">
			...
			<div class="form-group" data-type="sorted-list" data-sorted-list="role2group" data-item-template="admin/plugins/sso-auth0/partials/role2group-item" data-form-template="admin/plugins/sso-auth0/partials/role2group-form">
				<ul data-type="list" class="list-group"></ul>
				<button type="button" data-type="add" class="btn btn-info">Add Role-to-Group Association</button>
			</div>
		</div>
	</div>
</form>
